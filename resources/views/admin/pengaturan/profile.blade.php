                    ...
                    <div class="p-3">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" placeholder="Enter nomor telepon" name="no_telp"
                    ...
                    <div class="p-3">
                        ...
                        <div class="repeater">
                                                ...
                                                <div class="d-flex flex-row">
                                                    ...
                                                    <div class="col-5 mb-4 ps-2">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            @enderror"name="link"
                                                                    id="linkSosmed" placeholder="Link Sosmed"
                                                                    value="{{ $detail->link }}" required>
                                                                @error('link')
                                                                    <div class="invalid-feedback">
                                                                        <p>{{ $message }}</p>
                                                                    </div>
                                                ...
                                                <div class="d-flex flex-row">
                                                    <div class="col-6 mb-4 pe-3">
                                                        ...
                                                        <input required type="text"
                                                            class="form-control @error('sosmed-group.' . $i . '.name') is-invalid @enderror"
                            ...
                            <div class="hstack gap-2 justify-content-end">
                                <input class="btn btn-outline-success" data-repeater-create type="button"
                                    value="+ Tambah" />
                            </div>
                        </div>
                    </div>
