                    ...
                    <div class="col-md-6">
                        <div class="w-100">
                            ...
                            <input type="text" class="form-control @error('nama_mou') is-invalid @enderror"
                                name="nama_mou" placeholder="nama mou">
                            @error('nama_mou')
                                <div>
                        ...
                        <button type="submit" class="btn btn-primary me-2 mt-2">Tambah</button>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-6">
                            <label for="foto_mou" class="form-label">foto mou</label>
                            <input type="file" class="form-control @error('foto_mou') is-invalid @enderror"
                                name="foto_mou" id="myDropify">
                            @error('foto_mou')
                                <div>
                                    <p class="text-danger mt-2">{{ $message }}</p>
                                </div>
